...
class Request:
    ...
    Or specify a particular tool via {"type": "function", "function": {"name": "my_function"}}"""
    
    parallel_tool_calls: bool = False
    """ Whether to enable parallel function calling during tool use.
    If true, the model can call multiple functions simultaneously.
    If false, functions will be called sequentially. Only applies when tools are provided."""
    
    verbosity: str = "medium"
    """Controls the verbosity and length of the model response.
    Options: "low", "medium", "high"
    Lower values produce more concise responses, while higher values produce more detailed responses."""
    ...
    For non-OpenAI providers, it will be transformed accordingly."""
